...
Name:<input type="text" name="name" value="<?php echo $name;?>"> <span><?php echo $error_name; ?></span><br><br>
Email:<input type="text" name="email" value="<?php echo $email;?>"><span><?php echo $error_email; ?></span><br><br>
Address: <textarea name="address" cols="30" rows="10"><?php echo $address;?></textarea><span><?php echo $error_address; ?></span><br><br>
Gender: <input type="radio" name="gender" value="male" <?php if (isset($gender) && $gender=="female") echo "checked";?>> male
